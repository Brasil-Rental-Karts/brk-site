            ...
            {filteredChampionships.map((championship, index) => (
              ...
              >
                <Link to={`/campeonato/${championship.slug}`}>
                  <Card className="h-full flex flex-col overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1 relative cursor-pointer">
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                      ...
                      <CardContent className="p-6 flex flex-col flex-1 bg-white">
                        ...
                        {/* Indicador de ação - sempre no rodapé */}
